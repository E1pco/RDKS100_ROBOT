  ...
  public:
    ...
    // Estimate 3D position of the board using detected markers
        ...
        **/
        ...
        for (size_t i = 0; i < groups.size(); ++i)
        {
          if (best_candidate_score == 1 && groups_scores[i] == 1) {
            ...
            RCLCPP_ERROR(rclcpp::get_logger("QRDetect"),
        ...
        if (best_candidate_idx == -1)
        {
          ...
          RCLCPP_WARN(rclcpp::get_logger("QRDetect"),
      ...
      else
      {
        ...
        RCLCPP_WARN(rclcpp::get_logger("QRDetect"), "%lu marker(s) found, %d expected. Skipping frame...",
