...
Params loadParameters(rclcpp::Node::SharedPtr node) {
  ...
  node->get_parameter("annulus_half_width", params.annulus_half_width);
  node->get_parameter("board_width", params.board_width);
  node->get_parameter("board_height", params.board_height);
  node->get_parameter("board_roi_margin", params.board_roi_margin);
  node->get_parameter("board_roi_depth", params.board_roi_depth);
  node->get_parameter("auto_roi_voxel_leaf", params.auto_roi_voxel_leaf);
  node->get_parameter("annulus_voxel_leaf", params.annulus_voxel_leaf);
  ...
  node->get_parameter("use_auto_lidar_roi", params.use_auto_lidar_roi);
