...
def generate_launch_description():
    ...
    avia_config_cmd = os.path.join(config_dir, "mid360_mvs_nav.yaml")
    camera_config_cmd = os.path.join(config_dir, "camera_mvs.yaml")
    ...
    avia_config_arg = DeclareLaunchArgument(
        ...
        description="FAST-LIVO navigation parameter file.",
    )
