...
public:
  ...
  double visualization_voxel_size = 0.0;
  double visualization_publish_rate = 0.0;
  double last_visualization_publish_time = -1.0;
  ...
  int pub_scan_num = 1;
  int visualization_publish_every_n_frames = 1;
  int visualization_max_points = 0;
  int visualization_frame_count = 0;
  ...
  bool visualization_dense_map_en = false;
  ...
  PointCloudXYZI::Ptr pcl_w_wait_pcd_pub;
  PointCloudXYZI::Ptr pcl_wait_pub;
  PointCloudXYZI::Ptr pcl_wait_pcd_pub;
