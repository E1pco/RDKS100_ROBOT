...
def generate_launch_description():
    ...
    decoder_model_file_name_launch_arg = DeclareLaunchArgument(
        "sam_decoder_model_file_name", default_value=TextSubstitution(text="edgesam_decoder_512.hbm")
    )
    ...
    if camera_type == "usb":
        ...
        usb_node = IncludeLaunchDescription(
            ...
            launch_arguments={
                'usb_image_width': LaunchConfiguration('sam_image_width'),
                'usb_image_height': LaunchConfiguration('sam_image_height'),
