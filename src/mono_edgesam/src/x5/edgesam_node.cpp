...
int EdgeSamNode::SetNodePara() {
  ...
  // New API no longer provides tensorLayout; infer from numDimensions
  if (tensor_properties.validShape.numDimensions == 4) {
    ...
    // NHWC or HWC layout: [height, width, channel] or [batch, height, width, channel]
